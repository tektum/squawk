...
func TestEvaluate(t *testing.T) {
	tests := []struct {
		...
		{"unsupported range before ecosystem range", request{Ecosystem: "npm", Version: "1.5.0", Ranges: []affectedRange{{Type: "GIT"}, {Type: "ECOSYSTEM", Events: []event{{Introduced: "1.0.0"}, {Fixed: "2.0.0"}}}}}, "match"},
