...
| <a name="input_github_oidc_issuer"></a> [github\_oidc\_issuer](#input\_github\_oidc\_issuer) | n/a | `string` | `"https://token.actions.githubusercontent.com"` | no |
| <a name="input_github_oidc_jwks_url"></a> [github\_oidc\_jwks\_url](#input\_github\_oidc\_jwks\_url) | n/a | `string` | `"https://token.actions.githubusercontent.com/.well-known/jwks"` | no |
